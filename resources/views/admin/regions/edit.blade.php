<x-admin-layout>
    <div class="space-y-6">
        <div class="flex justify-between items-center">
            <h2 class="text-2xl font-semibold text-gray-900">Edit Region</h2>
                ...
                <form action="{{ route('admin.regions.update', $region) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <div class="mt-1">
                                <input type="text" name="name" id="name" value="{{ old('name', $region->name) }}" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md @error('name') border-red-300 text-red-900 placeholder-red-300 focus:outline-none focus:ring-red-500 focus:border-red-500 @enderror">
                                @error('name')
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                @if($region->cover_image)
                                    <div class="mb-4">
                                        <img src="{{ Storage::url($region->cover_image) }}" alt="Current cover image" class="h-32 w-32 object-cover rounded-lg">
                                    </div>
                                @endif
